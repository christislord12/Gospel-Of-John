...
Clazz.newMeth(C$, 'addF$javajs_util_T3',  function (t) {
this.x+=t.x;
this.y+=t.y;
this.z+=t.z;
});
...
Clazz.newMeth(C$, 'setP$javajs_util_T3',  function (t) {
this.set$D$D$D(t.x, t.y, t.z);
return this;
});

Clazz.newMeth(C$, 'putP$javajs_util_T3',  function (t) {
t.set$F$F$F(this.x, this.y, this.z);
return t;
});
})();
