...
if (addControls) p.add$java_awt_Component(C$.getControls(label));
...
), Clazz.new_(P$.HTML5Video$2.$init$,[this, {jsvideo:jsvideo,maxWidth:maxWidth,whenReady:whenReady,label:label,dialog:dialog}])), ["canplaythrough"]);
