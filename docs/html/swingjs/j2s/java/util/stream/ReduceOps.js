...
return Clazz.new_($I$(3,1),[this, {reducer:this.$finals$.reducer,combiner:this.$finals$.combiner,seed:this.$finals$.seed}],P$.ReduceOps$1ReducingSink);
});
})()
), Clazz.new_([this, {reducer:reducer,combiner:combiner,seed:seed}, $I$(5).REFERENCE],$I$(4,1).c$$java_util_stream_StreamShape,P$.ReduceOps$1));
}, 1);
...
), Clazz.new_([this, {combiner:combiner,collector:collector,supplier:supplier,accumulator:accumulator}, $I$(5).REFERENCE],$I$(4,1).c$$java_util_stream_StreamShape,P$.ReduceOps$3));
}, 1);
...
;Clazz.setTVer('3.3.1-v5');//Created 2022-08-27 14:14:00 Java2ScriptVisitor version 3.3.1-v5 net.sf.j2s.core.jar version 3.3.1-v5
